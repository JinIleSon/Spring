...
public class ShopRepositoryTest {
    ...
    public void test4(){
        ...
        List<Customer> customerList = queryFactory
                ...
                .where(qCustomer.custName.eq("김유신"))
                .fetch();
        ...
        List<Customer> resultList = queryFactory
                .selectFrom(qCustomer)
                .where(qCustomer.custName.ne("김유신"))
                .fetch();
    ...
    public void test6(){
        ...
        List<Customer> list = queryFactory.selectFrom(qCustomer)
                .where(qCustomer.custName.like("%신"))
                .fetch();
    ...
    public void test12(){
        ...
        if(name != null){
            builder.and(qCustomer.custName.eq(name));
        }
